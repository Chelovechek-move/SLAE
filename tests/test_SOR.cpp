...
#include "my_project/solvers/SOR.hpp"

TEST(TestSuccessiveOverRelaxation, Test) {
    ...
    auto res = Slae::Solvers::SuccessiveOverRelaxation(TestMatrix, b, InitialState, Tolerance);
