...
#include "my_project/solvers/SOR_.hpp"

TEST(TestSuccessiveOverRelaxation_, Test) {
    ...
    auto res = Slae::Solvers::SuccessiveOverRelaxation_(TestMatrix, b, InitialState, Tolerance);
