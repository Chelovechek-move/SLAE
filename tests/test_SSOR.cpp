...
#include "my_project/solvers/SSOR.hpp"

TEST(TestSymmetricSuccessiveOverRelaxation, Test) {
    ...
    auto res = Slae::Solvers::SymmetricSuccessiveOverRelaxation(TestMatrix, b, InitialState, Tolerance);
